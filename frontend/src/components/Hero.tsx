  ...
  return (
    <section id="hero" style={styles.section} aria-label="Introduction">
      ...
      <h2 style={styles.tagline}>
        ...
        <br />
        <span style={styles.taglineSub}>AWS Certified - AI and Cloud</span>
      </h2>
      ...
      <p style={styles.summary}>
        ...
        <br />- AWS Certified AI Practitioner and Developer – Associate — testing AI-powered
        features
      ...
      <div style={styles.ctaRow}>
        <a href="#contact" className="btn" aria-label="Go to contact section">
          <svg height="20" width="20" viewBox="0 0 24 24" fill="currentColor" style={styles.icon}>
