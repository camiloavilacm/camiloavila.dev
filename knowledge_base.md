# Camilo Avila — AI Resume Knowledge Base

> This document is the single source of truth used by the AI Resume Assistant chatbot on camiloavila.dev.
> It is structured for optimal LLM retrieval. All answers the chatbot provides must originate from this document.
...
- **Location:** Sueca, Comunidad Valenciana, Spain
- **Availability:** US working hours
- **Languages Spoken:** Spanish (Native/Bilingual), English (Full Professional), French (Full Professional), Portuguese (Full Professional), Italian (Limited Working)

---

## 2. Professional Summary

Camilo Avila is a polyglot Senior QA Automation Engineer with over 15 years of experience across software quality, automation, and cloud engineering. He holds two active AWS certifications and specialises in designing, developing, and maintaining automation frameworks for web, mobile, API, and microservices testing.
...
- Katalon Studio (Groovy and JavaScript)
...
- AWS Cloud Architecture (in progress)
...
- Test plan design and maintenance
...
1. **AWS Certified Developer – Associate**
   - Validates ability to develop, deploy, and debug cloud-based applications using AWS services.
...
- Implemented CI/CD with Docker, AWS CodePipeline, and other AWS services
- Conducted performance testing
- Designed and maintained test plans for Mobile (iOS and Android), Web, API, and microservices
...
- Conducted functional and integration testing with Python, Postman, SoapUI, and JMeter for load testing
...
- Managed team task assignments
- Implemented Agile testing methodologies and processes
...
- Built a C# automation framework using C#, Selenium, and Visual Studio Code
- Implemented HP UFT as automation tool for desktop and web software
...
- **Puppeteer Automation:** Advanced browser automation workflows using Puppeteer for QA and scraping use cases
- **Job Search Automation:** Built web scraping tools in Python to automate job search and filtering processes
- **QA Browser Workflows:** Developed browser automation scripts for specialised QA environments and test coverage improvements

---

## 8. Personal Interests & Hobbies

- Photography (professional background — wedding and portrait photography)
- Reading
- Technology and staying current with emerging tools and cloud services
...
He is open to remote positions with US-based clients or companies. He brings AWS certification, multilingual communication skills (5 languages), and 15+ years of automation experience across multiple industries and frameworks.
